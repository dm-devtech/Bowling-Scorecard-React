...
describe('Print class', function() {
  ...
  it('when given hash output function returns all turns', function() {
    let string = print.output({1.1:0, 1.2:2, 2.1:5, 2.2:2, 3.1:6, 3.2:2, 4.1:0, 4.2:0, 5.1:0, 5.2:0, 6.1:0, 6.2:0, 7.1:0, 7.2:0, 8.1:0, 8.2:0, 9.1:0, 9.2:0, 10.1:0, 10.2:0, 10.3:0}, 17, 3)
